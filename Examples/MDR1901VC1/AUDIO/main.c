...
/* Enable peripheral clocks --------------------------------------------------*/
	RST_CLK_PCLKcmd(RST_CLK_PCLK_AUDIO_IP,ENABLE);
...
void ConfigureDSPClock(void)
{
	  ...
	  /* Config the DSP PLL */
	  RST_CLK_DSPPLLConfig(DSP_PLL_MUL1);
	  ...
	  DSP_CLKPCLKCmd((DSP_CLK_PCLK_CDM | DSP_CLK_PCLK_CPM |
			          DSP_CLK_PCLK_CPU | DSP_CLK_PCLK_CDC), ENABLE);
}
